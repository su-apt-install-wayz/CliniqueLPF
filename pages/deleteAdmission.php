        ...
        if(isset($_POST['submit'])) {
            ...
            if (is_secsocnum($num_secu) ) {
                ...
                if(isset($hospi['Num_secu'])) {
                    ...
                    header('Location: hospitalisation_delete.php');
                    exit; 
                }
                else {
...
<body> 
    ...
    <h1>Supprimer une admission</h1>
        <form style="margin:auto; width: 100%; max-width: 500px;" action="" method="post">
            ...
            <input style="margin:20px auto;" class="btn-envoi moyen" type="submit" value="Rechercher pour supprimer" name="submit">
